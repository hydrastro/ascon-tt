...
.PHONY: all help clean tt12-patch-librelane \
  ...
  tt17-capture \
  harden-128a-gf26a harden-128a-gf26a-slow harden-128-gf26a harden-128-gf26a-slow tt12-create-user-config tt12-create-tt-submission
...
help:
	...
	@echo "      --pdk gf180mcuD --tiles 4x4 --clock-hz 10000000 --variant 1 --rpc 1"
	@echo ""
	...
	@echo ""
	@echo "  make harden-128a-gf26a                   one-shot: 128a, 4x4, 10MHz"
	@echo "  make harden-128a-gf26a-slow              one-shot: 128a, 4x4, 5MHz"
	@echo "  make harden-128-gf26a                    one-shot: 128, 4x4, 10MHz"
	@echo "  make harden-128-gf26a-slow               one-shot: 128, 4x4, 5MHz"
	@echo ""
...
tt12-create-user-config: tt12-write-user-config
...
# ── GF26a one-shot harden targets ─────────────────────────────────────────────
harden-128a-gf26a:
	python3 tools/tt15_set_tt_config.py --pdk gf180mcuD --tiles 4x4 --clock-hz 10000000 --variant 1 --rpc 1
	$(MAKE) tt12-harden ASCON_VARIANT=1 ROUNDS_PER_CYCLE=1

harden-128a-gf26a-slow:
	python3 tools/tt15_set_tt_config.py --pdk gf180mcuD --tiles 4x4 --clock-hz 5000000 --variant 1 --rpc 1
	$(MAKE) tt12-harden ASCON_VARIANT=1 ROUNDS_PER_CYCLE=1

harden-128-gf26a:
	python3 tools/tt15_set_tt_config.py --pdk gf180mcuD --tiles 4x4 --clock-hz 10000000 --variant 0 --rpc 1
	$(MAKE) tt12-harden ASCON_VARIANT=0 ROUNDS_PER_CYCLE=1

harden-128-gf26a-slow:
